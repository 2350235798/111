...
// 统一从本地类型文件导入 AccountType
export type { AccountType } from '@client/src/components/business-ui/types/services';
import type { AccountType } from '@client/src/components/business-ui/types/services';
